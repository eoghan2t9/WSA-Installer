namespace WSA_Installer.Pages
{
    partial class ComfirmUninstall
    {
        ...
        private void InitializeComponent()
        {
			...
			this.infoLbl.Size = new System.Drawing.Size(423, 13);
			this.infoLbl.TabIndex = 0;
			this.infoLbl.Text = "WSA will be uninstalled from the following folder. Click Uninstall to start the u" +
    "ninstallation.";
			// 
			// label1
			// 
			...
			// 
			this.uninstallLocationBox.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(33)))), ((int)(((byte)(33)))), ((int)(((byte)(33)))));
			this.uninstallLocationBox.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
