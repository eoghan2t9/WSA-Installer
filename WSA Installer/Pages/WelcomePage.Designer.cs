namespace WSA_Installer.Pages
{
    partial class WelcomePage
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label5.Text = "Welcome to the WSA Setup Wizard";
			// 
			// label4
			// 
			...
			this.label4.Text = "This installer was designed to automate the tedious process of installing WSA and" +
    " setting up GApps Integration.";
			// 
			// label3
			// 
			...
			this.label1.Text = "This wizard will guide you through the installation process of Windows Subsystem " +
    "for Android (WSA)";
			// 
			// logoBox
			// 
			this.logoBox.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(33)))), ((int)(((byte)(33)))), ((int)(((byte)(33)))));
			this.logoBox.Image = global::WSA_Installer.Properties.Resources.welcomeBanner4;
